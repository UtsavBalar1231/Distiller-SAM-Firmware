# Author: PamirAI - Threaded Task Manager
# Date: 2025-07-15
# Version: 1.0.0
# Description: Non-blocking task manager to prevent UART interference from long-running operations
...
class ThreadedTaskManager:
    ...
    def submit_uart_task(self, name, function, args=None, completion_callback=None):
        ...
        Returns:
            int: Task ID
        """
        return self.submit_task(name, function, args, self.PRIORITY_CRITICAL, completion_callback)
    ...
    def submit_led_task(self, name, function, args=None, completion_callback=None):
        ...
        Returns:
            int: Task ID
        """
        return self.submit_task(name, function, args, self.PRIORITY_NORMAL, completion_callback)
    ...
    def submit_display_task(self, name, function, args=None, completion_callback=None):
        ...
        Returns:
            int: Task ID
        """
        return self.submit_task(name, function, args, self.PRIORITY_LOW, completion_callback)
    ...
    def get_statistics(self):
        ...
        if uptime > 0:
            stats["core0_utilization_percent"] = min(100, (self.stats["core0_busy_time"] * 100) // uptime)
            stats["core1_utilization_percent"] = min(100, (self.stats["core1_busy_time"] * 100) // uptime)
        else:
