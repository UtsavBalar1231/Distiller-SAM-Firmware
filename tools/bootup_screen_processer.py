...
image = Image.open("/Users/chengmingzhang/Desktop/white.png").convert("L")
...
# Save to binary file
file_path = '/Users/chengmingzhang/CodingProjects/Software/Distiller-SAM-Firmware/Bin/DistillerAlpha/loading1.bin'
